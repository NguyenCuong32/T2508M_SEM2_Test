    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Gosho Aoyama", 2.50m, "Conan" },
                    { 2, "Fujiko F. Fujio", 2.00m, "Doraemon" },
                    { 3, "Akira Toriyama", 3.00m, "Dragon Ball" },
                    { 4, "Masashi Kishimoto", 2.50m, "Naruto" },
                    { 5, "Eiichiro Oda", 3.50m, "One Piece" }
                });

            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerID", "FullName", "PhoneNumber", "Registration" },
                values: new object[,]
                {
                    { 1, "Nguyen Hung", "0901234567", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, "Tran Van A", "0912345678", new DateTime(2024, 2, 15, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
